...
export function PrivacyContent() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-24 sm:py-32">
      ...
      >
        <h1 className="mb-2 font-display text-5xl">Privacy Policy</h1>
        ...
        <section className="mb-12 space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            If you have any questions about how your privacy is handled, please contact us at <a href="mailto:hello@chatlore.app" className="text-primary hover:underline transition-colors">hello@chatlore.app</a>.
          </p>
        </section>
      </motion.div>
    </div>
