      ...
      <div className="mx-auto max-w-3xl">
        ...
        >
          ...
          <h2 className="mb-3 font-display text-3xl sm:text-4xl">
            One profile for <span className="italic text-primary">every assistant</span>
          </h2>
        ...
        <motion.div
          ...
          className="overflow-hidden rounded-xl border border-border/40 shadow-2xl shadow-primary/5"
        >
          <div className="flex items-center gap-2 border-b border-neutral-800 bg-neutral-950 px-4 py-2.5">
            ...
            <span className="size-2.5 rounded-full bg-neutral-700" />
            <span className="size-2.5 rounded-full bg-neutral-700" />
            <span className="ml-2 font-mono text-[11px] text-neutral-500 uppercase tracking-wider">
